...
return array(
	'title'      => __( '404', 'eduacademy' ),
	'categories' => array( 'eduacademy' ),
	'keywords'   => array( 'content' ),
	'inserter'   => false,
	'content'    => '<!-- wp:cover {"url":"' . esc_url( $eduacademy_img04 ) . '","id":299,"dimRatio":90,"overlayColor":"ti-bg-inv","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","tagName":"main","align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
<main class="wp-block-cover alignfull" style="margin-top:0;margin-bottom:0;min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-ti-bg-inv-background-color has-background-dim-90 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-299" alt="" src="' . esc_url( $eduacademy_img04 ) . '" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"64px","bottom":"64px"},"blockGap":"40px"}},"textColor":"ti-bg","layout":{"type":"constrained"}} -->
