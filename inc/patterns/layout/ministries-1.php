...
$eduacademy_img01 = Assets_Manager::get_image_url( 'eduacademy-1.webp' );
...
return array(
	'title'      => __( 'Ministries', 'eduacademy' ),
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Find Your Place at Eduacademy</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="' . esc_url( $eduacademy_img01 ) . '" alt="" class="wp-image-296" style="border-radius:8px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="' . esc_url( $eduacademy_img04 ) . '" alt="" class="wp-image-299" style="border-radius:8px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-large has-custom-border"><img src="' . esc_url( $eduacademy_img03 ) . '" alt="" class="wp-image-298" style="border-radius:8px"/></figure>
<!-- /wp:image -->
