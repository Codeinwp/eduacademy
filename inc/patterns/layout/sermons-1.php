...
$eduacademy_img02 = Assets_Manager::get_image_url( 'eduacademy-2.webp' );
...
$eduacademy_img07 = Assets_Manager::get_image_url( 'eduacademy-7.webp' );

return array(
	'title'      => __( 'Sermons', 'eduacademy' ),
...
<figure class="wp-block-image size-full has-custom-border"><img src="' . esc_url( $eduacademy_img07 ) . '" alt="" class="wp-image-303" style="border-radius:8px;aspect-ratio:16/9;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="' . esc_url( $eduacademy_img02 ) . '" alt="" class="wp-image-297" style="border-radius:8px;aspect-ratio:16/9;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="' . esc_url( $eduacademy_img06 ) . '" alt="" class="wp-image-301" style="border-radius:8px;aspect-ratio:16/9;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="' . esc_url( $eduacademy_img04 ) . '" alt="" class="wp-image-299" style="border-radius:8px;aspect-ratio:16/9;object-fit:cover"/></figure>
<!-- /wp:image -->
